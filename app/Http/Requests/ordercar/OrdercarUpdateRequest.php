...
namespace App\Http\Requests\ordercar;

use Illuminate\Foundation\Http\FormRequest;

class OrdercarUpdateRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'car_id.required' => 'هذه الخانه مطلوبه',
            'user_id.exists' => 'هذا المستخدم غير موجود',
            'car_id.exists' => 'هذا المستخدم غير موجود',
