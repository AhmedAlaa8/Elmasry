                    ...
                    <form method="post" action="{{ route('admin.store.update', $store->id) }}">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $store->name_category }}" class="form-control"
                                    id="text" name="name_category">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ $store->salary_category }}" class="form-control"
