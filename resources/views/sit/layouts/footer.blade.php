...
<script src="{{ asset('sit') }}/lib/easing/easing.min.js"></script>
<script src="{{ asset('sit') }}/lib/waypoints/waypoints.min.js"></script>
<script src="{{ asset('sit') }}/lib/owlcarousel/owl.carousel.min.js"></script>
<script src="{{ asset('sit') }}/lib/tempusdominus/js/moment.min.js"></script>
<script src="{{ asset('sit') }}/lib/tempusdominus/js/moment-timezone.min.js"></script>
<script src="{{ asset('sit') }}/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
